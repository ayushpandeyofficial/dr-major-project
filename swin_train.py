...
# Assuming that your output dimension is `num_classes`
num_classes = 5  # Change this to the actual number of classes in your task
...
for epoch in range(EPOCHS):
    ...
    for i, (images, labels) in enumerate(train_data_loader):
        ...
        # Adjust the line to handle the CrossEntropyLoss with single-dimensional target
